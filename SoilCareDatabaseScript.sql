...
CREATE TABLE UserLand(
	...
	Created_at datetime,
	[Status] nvarchar(200),
	CONSTRAINT UserLand_pk PRIMARY KEY(Land_id),
	CONSTRAINT UserLand_fk FOREIGN KEY(User_id) REFERENCES [User](User_id),
);
...
CREATE TABLE Measurement(
	...
	CONSTRAINT Measurement_fk1 FOREIGN KEY(Land_id) REFERENCES UserLand(Land_id),
...
CREATE TABLE SolutionOffer(
	...
	Solution_id nvarchar(200),
	Value_config float,
	Unit_config nvarchar(200),
	[Status] navarchar(200),
