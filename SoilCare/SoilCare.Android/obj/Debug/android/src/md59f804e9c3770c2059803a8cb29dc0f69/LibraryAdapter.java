...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SoilCare.Android.AdapterClass.LibraryAdapter, SoilCare.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", LibraryAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == LibraryAdapter.class)
			mono.android.TypeManager.Activate ("SoilCare.Android.AdapterClass.LibraryAdapter, SoilCare.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
